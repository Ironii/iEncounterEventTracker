...
function iEET:CreateMainFrame()
	...
	iEET.spreadsheetCopyButton:SetBackdropColor(iEETConfig.colors.main.bg.r,iEETConfig.colors.main.bg.g,iEETConfig.colors.main.bg.b,iEETConfig.colors.main.bg.a)
	iEET.spreadsheetCopyButton.text = iEET.spreadsheetCopyButton:CreateFontString()
	iEET.spreadsheetCopyButton.text:SetFont(iEET.font, iEET.fontsize, 'OUTLINE')
	...
	iEET.filteringButton:SetBackdrop(iEET.backdrop);
	iEET.filteringButton:SetBackdropColor(iEETConfig.colors.main.bg.r,iEETConfig.colors.main.bg.g,iEETConfig.colors.main.bg.b,iEETConfig.colors.main.bg.a)
	iEET.filteringButton.text = iEET.filteringButton:CreateFontString()
	iEET.filteringButton.text:SetFont(iEET.font, iEET.fontsize, 'OUTLINE')
	...
	iEET.filteringButton:RegisterForClicks('AnyUp')
